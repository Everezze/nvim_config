...
local capabilities = require('/home/omarsalim/.local/share/nvim/plugged/cmp-nvim-lsp/lua/cmp_nvim_lsp/init.lua').update_capabilities(vim.lsp.protocol.make_client_capabilities())
...
local servers = { 'html', 'cssls', 'tsserver', 'emmet_ls', 'vimls', 'pyright', 'intelephense' }
